...
Some definitions are incomplete like constructor method and method
...
ez sequence to remember on OOPs , then we will write the code
...
Proper sequence to know how it works
(added constructor method and method )
(anything covered with [] is example code after || down below )
